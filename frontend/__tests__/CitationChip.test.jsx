...
describe('CitationChip', () => {
  it('renders [Source: title] as a link with the source_url', () => {
    render(
      <CitationChip citation={{ title: 'FastAPI Docs', source_url: 'https://fastapi.tiangolo.com' }} />,
    );
  ...
  it('supports camelCase sourceUrl key', () => {
    render(
      <CitationChip citation={{ title: 'Doc', sourceUrl: 'https://example.com' }} />,
    );
    expect(screen.getByTestId('citation-chip')).toHaveAttribute('href', 'https://example.com');
  });
});
